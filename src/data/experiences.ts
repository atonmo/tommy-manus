...
export const experiences: Experience[] = [
  {
    ...
    position: '产品体验设计师｜UI 组小队长',
    company: 'Web3 某头部衍生品交易所',
    description:
  ...
  },
  {
    ...
    position: '设计负责人',
    company: '腾讯云政务 / 健康码 / 国务院领事馆等',
    description:
      '主导天府健康通、北京通、国务院领事馆、云南扶助平台、光山号等产品设计；负责从角色定义、典型场景到架构、页面布局与体验创新的全链路规划与执行；兼任设计资产协同工具 Dithub 产品经理；围绕适老化设计、会议产品设计方法等课题做知识沉淀与外部课程分享，并多次派驻一线指导合作伙伴。',
  },
  {
    start: '2016',
    end: '2022',
